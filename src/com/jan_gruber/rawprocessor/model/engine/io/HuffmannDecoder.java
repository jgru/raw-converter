 ...
 ***********************************************************************************************************************
 *
 * $Id: HuffmannDecoder.java,v af350c73f482 2009/09/10 12:30:05 fabrizio $
 *
 **********************************************************************************************************************/
 ...
 * @version $Id: HuffmannDecoder.java,v af350c73f482 2009/09/10 12:30:05 fabrizio $
 *
 **********************************************************************************************************************/
public class HuffmannDecoder
  {
     ...
     *
     ******************************************************************************************************************/
    public static HuffmannDecoder[] createDecoders (final  short[] ... sources)
      {
     ...
     * 
     ******************************************************************************************************************/
    public static HuffmannDecoder createDecoder (final short[] source)
      {
    ...
    public static HuffmannDecoder createDecoder (final  byte[] source, final int start)
      {
        leafCounter = 0;
     ...
     * 
     ******************************************************************************************************************/
    public static HuffmannDecoder createDecoderWithJpegHack (final  byte[] source, final int start)
      {
        leafCounter = 0;
     ...
     * 
     ******************************************************************************************************************/
    private static HuffmannDecoder createDecoder (final  byte[] source,
                                                  int start,
                                                  int level,
                                                  boolean jpgHack)
      {
     ...
     * 
     ******************************************************************************************************************/
    private static void createDecoder (final HuffmannDecoder dest,
                                       final byte[] source,
                                       int start,
                                       int level,
                                       boolean jpgHack)
    ...
    /*******************************************************************************************************************
     * 
     * Reads an encoded value from a {@link FastBitReader} and returns the decoded value.
     *  
     ...
     * 
     ******************************************************************************************************************/
    public int decode (final  ImageInputStream br)
      throws IOException
      {
     ...
     *
     ******************************************************************************************************************/
    public int readSignedBits (final  ImageInputStream iis,
                               final int bitCount)
      throws IOException
      {
